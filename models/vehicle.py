...
class Vehicle(db.Model):
    ...
    # Types: 'legal_il' (Yellow Plate), 'legal_pal' (White/Green Plate), 'mushtuba' (No Plate/Illegal)
    ...
    risk = db.Column(db.Integer, default=0) # 0-100% chance of seizure by police
