...
class UserLog(db.Model):
    ...
    ip_address = db.Column(
        db.String(45),
        nullable=True)  # IPv6 is max 45 chars
...
class EconomySnapshot(db.Model):
    ...
    # Percentage of total wealth held by top 1%
    top_1_percent_share = db.Column(db.Float, default=0.0)
...
class MoneySinkLog(db.Model):
    ...
    user_id = db.Column(
        ...
        nullable=False,
        index=True)
    # bank_fee, property_maintenance, repair, upgrade, etc.
    sink_type = db.Column(db.String(50), nullable=False)
    amount = db.Column(db.Integer, nullable=False)
    # e.g., "Tier 2 Fee", "Villa Maintenance"
