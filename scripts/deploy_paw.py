...
def main():
    ...
    if not os.path.exists(env_path):
        ...
        with open(env_path, 'w') as f:
            ...
            # Default to SQLite for safety, but user should change to
            # MySQL/Postgres on PAW
    ...
    # PAW requires you to map /static to the static folder manually in the web
    # tab.
    ...
    print(
        "3. Set 'WSGI configuration file' to point to: " +
        os.path.join(
            project_root,
            'wsgi.py'))
