...
def seed_auctions():
    ...
    with app.app_context():
        ...
        existing_item_auction = Auction.query.filter_by(
            item_type='item', item_id=str(
                item.id), status='active').first()
        ...
        existing_veh_auction = Auction.query.filter_by(
            item_type='vehicle', item_id=str(
                vehicle.id), status='active').first()
