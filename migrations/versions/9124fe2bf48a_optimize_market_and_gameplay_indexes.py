...
def upgrade():
    ...
    ensure_index('idx_crime_lobby_status_created', 'crime_lobby', ['status', 'created_at'])
    ...
    ensure_index('idx_futures_liq_check', 'futures_position', ['asset_id', 'is_open', 'position_type', 'liquidation_price'])
    ensure_index('idx_futures_position_user_open', 'futures_position', ['user_id', 'is_open'])
    ensure_index('ix_futures_position_asset_id', 'futures_position', ['asset_id'])
    ensure_index('ix_futures_position_closed_at', 'futures_position', ['closed_at'])
    ensure_index('ix_futures_position_is_open', 'futures_position', ['is_open'])
    ensure_index('ix_futures_position_liquidation_price', 'futures_position', ['liquidation_price'])
    ensure_index('ix_futures_position_opened_at', 'futures_position', ['opened_at'])
    ensure_index('ix_futures_position_position_type', 'futures_position', ['position_type'])
    ...
    ensure_index('ix_heist_history_created_at', 'heist_history', ['created_at'])
    ensure_index('ix_hostess_knowledge_hostess_id', 'hostess_knowledge', ['hostess_id'])
    ...
    ensure_index('ix_organized_crime_is_active', 'organized_crime', ['is_active'])
    ensure_index('ix_organized_crime_min_gang_level', 'organized_crime', ['min_gang_level'])
    ensure_index('ix_organized_crime_min_level', 'organized_crime', ['min_level'])
    ensure_index('ix_payment_transaction_user_id', 'payment_transaction', ['user_id'])
    ensure_index('ix_public_chat_user_id', 'public_chat', ['user_id'])
    ensure_index('ix_race_creator_id', 'race', ['creator_id'])
    ensure_index('ix_race_participant_race_id', 'race_participant', ['race_id'])
    ensure_index('ix_race_participant_user_id', 'race_participant', ['user_id'])
    ensure_index('ix_race_participant_user_vehicle_id', 'race_participant', ['user_vehicle_id'])
    ensure_index('ix_referral_referred_id', 'referral', ['referred_id'])
    ensure_index('ix_referral_referrer_id', 'referral', ['referrer_id'])
    ensure_index('idx_spot_order_exec_buy', 'spot_order', ['asset_id', 'status', 'order_type', 'price'])
    ...
    ensure_index('ix_user_crime_cooldown_cooldown_until', 'user_crime_cooldown', ['cooldown_until'])
    ensure_index('ix_user_crime_cooldown_crime_id', 'user_crime_cooldown', ['crime_id'])
    ensure_index('ix_user_crime_cooldown_user_id', 'user_crime_cooldown', ['user_id'])
    ensure_index('idx_user_crime_cooldown_user_crime', 'user_crime_cooldown', ['user_id', 'crime_id'])
    ...
    ensure_index('idx_user_investment_user_asset', 'user_investment', ['user_id', 'asset_id'], unique=True)
    ensure_index('ix_user_investment_asset_id', 'user_investment', ['asset_id'])
    ensure_index('ix_user_item_item_id', 'user_item', ['item_id'])
    ensure_index('ix_user_item_user_id', 'user_item', ['user_id'])
    ensure_index('idx_user_org_crime_cooldown_user_crime', 'user_organized_crime_cooldown', ['user_id', 'crime_id'], unique=True)
    ensure_index('ix_user_organized_crime_cooldown_cooldown_until', 'user_organized_crime_cooldown', ['cooldown_until'])
    ensure_index('ix_user_organized_crime_cooldown_crime_id', 'user_organized_crime_cooldown', ['crime_id'])
    ensure_index('ix_user_organized_crime_cooldown_user_id', 'user_organized_crime_cooldown', ['user_id'])
    ...
    with op.batch_alter_table('hostess_chat_messages', schema=None) as batch_op:
        batch_op.create_foreign_key('fk_hostess_chat_messages_user_id', 'user', ['user_id'], ['id'])

    with op.batch_alter_table('hostess_memories', schema=None) as batch_op:
        batch_op.create_foreign_key('fk_hostess_memories_user_id', 'user', ['user_id'], ['id'])

    with op.batch_alter_table('user', schema=None) as batch_op:
        batch_op.create_foreign_key('fk_user_active_hostess_id', 'hostesses', ['active_hostess_id'], ['id'])
